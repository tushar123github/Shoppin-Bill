...
public class ShoppingBill {
	...
	public static void main(String[] args) {
		...
		int quentity = 14;
		double price = 0.0;
		double overAllPrice =1.2;
		double cgst,sgst,subtotal= 1.2,discount= 0.0;
		char choice = '\0';
         ...
         do   
             {  
                 ...
                 overAllPrice = price * quentity;  
                 //calculates overall price  
                 overAllPrice = overAllPrice + overAllPrice;  
                 //creates Product class object and add it to the List  
                 product.add( new Product(id, productName, quentity, price, overAllPrice) );  
